...
export default (props) => {
    ...
    <h2 style={{marginTop:20}}>What kind of jobs would you like to do for Fundraisers?</h2>
    <FormGroup class="switch">
  <FormControlLabel style={{display:"block"}}
    control={<Switch checked={checked1} onChange={planningCommitee} />}
    label="I would like to host a fundraising event in my home"
  />
  <FormControlLabel style={{display:"block"}}
    control={<Switch checked={checked2} onChange={weekBefore} />}
    label="I am willing to do a virtual party"
  />
  <FormControlLabel style={{display:"block"}}
    control={<Switch checked={checked3} onChange={dayOf} />}
    label="I have a small buisness that will host a BB4K fundraiser"
  />
  <FormControlLabel style={{display:"block"}}
    control={<Switch checked={checked4} onChange={event} />}
    label="I have an idea for a fundraiser"
  />
  <FormControlLabel style={{display:"block"}}
    control={<Switch checked={checked5} onChange={child} />}
    label="I would personally like to raise funds for a specific child"
  />
</FormGroup>
<div>

...
export default (props) => {
    ...
    <h2 style={{marginTop:20}}>What kind of services could you provide to be a Kindness Courier</h2>
    <FormGroup class="switch">
  <FormControlLabel style={{display:"block"}}
    control={<Switch checked={checked1} onChange={planningCommitee} />}
    label="Acces to a truck or a vehicle to transport equipment"
  />
  <FormControlLabel style={{display:"block"}}
    control={<Switch checked={checked2} onChange={weekBefore} />}
    label="Don't have a vehicle but willing to help move and lift equipment"
  />
</FormGroup>
<div>
